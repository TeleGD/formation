...
public class World extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1) {
		...
		// Cr�ation de la liste contenant les murs
		walls=new ArrayList<Wall>();
		
		// Initialisation de cette liste, le premier mur de toutes les parties sera le m�me. Les suivants sont al�atoires
		walls.add(new Wall(20,150,Nico));
		
		// Cr�ation du g�n�rateur de mur
	...
	public void update(GameContainer arg0, StateBasedGame arg1, int arg2) {
		...
		// Mise � jour de tous les murs (1 par 1)
		for(Wall w:walls) { // for each
			w.update(arg0, arg1, arg2);
		}
		
		// Destruction des murs s'il y a eu collision (on les retire de la liste des murs existants et java les supprime car ils ne sont plus reli�s � rien)
		...
		// Mise � jour du g�n�rateur de murs (ajout d'un nouveau mur ?)
